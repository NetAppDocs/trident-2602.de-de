...
summary: Sie können mit der Versionsauswahl zwischen der neuesten Version und den vorherigen vier Versionen navigieren oder die unten stehenden Links verwenden. 
---
...
[role="lead"]
Falls Sie nicht Trident 26.02 verwenden, ist die Dokumentation für frühere Versionen basierend auf der link:get-help.html["Trident Support-Lebenszyklus"] verfügbar.
